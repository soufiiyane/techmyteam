        ...
        <div className="flex flex-wrap md:flex-nowrap md:items-center md:justify-between gap-8 md:gap-0">
          <div className="animate_left md:w-[70%] lg:w-1/2">
            <h2 className="text-black dark:text-white text-3xl xl:text-sectiontitle4 font-bold mb-4 w-11/12">
              Propulsez Votre Entreprise vers le Futur Numérique
            </h2>
            <p>
              Découvrez des solutions IT sur mesure, des sites web innovants, des CRM puissants et des solutions cloud avancées. Transformez vos défis en opportunités avec notre expertise technologique de pointe.
            </p>
          </div>
