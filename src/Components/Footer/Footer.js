                    ...
                    <div className="flex flex-wrap lg:justify-between gap-8 lg:gap-0">
                        ...
                        <div
                            ...
                            <div className="animate_top">
                                <h4 className="font-medium text-black dark:text-white text-itemtitle2 mb-9">Quick
                                    Links</h4>
                                <ul>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Home</a></li>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Product</a></li>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Careers</a></li>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Pricing</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="animate_top">
                                ...
                                <ul>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Company</a></li>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Press media</a>
                                    </li>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Our Blog</a></li>
                                    <li><a href="#" className="inline-block hover:text-primary mb-3">Contact Us</a></li>
                                </ul>
                            </div>
                                ...
                                <form action="#">
                                    <div className="relative">
                                        ...
                                        <button className="absolute right-0 p-4">
                                            <svg className="fill-[#757693] dark:fill-white hover:fill-primary"
