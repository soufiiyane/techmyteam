    ...
    return (
        <section className="py-20 lg:py-22.5 px-4 md:px-8 2xl:px-0">
            ...
            >
                ...
                <img src="./images/shape/shape-dotted-light-02.svg" alt="Dotted" className="absolute top-0 left-0 -z-1 dark:hidden" />
                <img src="./images/shape/shape-dotted-dark-02.svg" alt="Dotted" className="absolute top-0 left-0 -z-1 hidden dark:block" />
                ...
                <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
                    <div className="animate_top text-center">
                        <h3 className="font-bold text-black dark:text-white text-3xl xl:text-sectiontitle3 mb-2.5">500K</h3>
                        <p className="text-lg lg:text-para2">World Wide Clients</p>
                    </div>
                    <div className="animate_top text-center">
                        <h3 className="font-bold text-black dark:text-white text-3xl xl:text-sectiontitle3 mb-2.5">1M+</h3>
                        <p className="text-lg lg:text-para2">Downloads</p>
                    </div>
                    <div className="animate_top text-center">
                        <h3 className="font-bold text-black dark:text-white text-3xl xl:text-sectiontitle3 mb-2.5">865</h3>
